...
define('GITHUB_SECRET', 'Montpel#2015');
// name of the git branch that you're deploying
define('GITHUB_BRANCH', 'calendra');
// your email address, where you'll receive notices of deploy successes/failures
define('EMAIL_RECIPIENT', 'benjamin@achiary.com');
// domain of your website
define('SITE_DOMAIN', 'benjaminachiary.com');
